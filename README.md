...
create/open metadata, policy and inferred create helpers, bulk f32/f64/i32/i64
append/read helpers, universe-aware authoring, current and historical read
options and shape policies, write-forward compression controls, scoped f32/f64
rewrite/clear-block mutation helpers, scoped reform/compaction workflows, and
V4 diagnostics/precise-accounting reports. Query attribution, zero-copy native
views, native coordinate lookup helpers, private maintainer-only hooks, native
artifact publication, and performance/storage/capacity claims are outside this
source export.
